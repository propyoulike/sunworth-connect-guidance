...
const CustomerSpeaks = ({ onCtaClick }: CustomerSpeaksProps) => {
  const sectionRef = useRef<HTMLDivElement | null>(null); // ✅ FIX ADDED
  ...
  const testimonials = [
    {
      ...
      videoId: "k-dD6PtfrC8",
      quote:
        "The amenities and green spaces are exactly what we were looking for. Our kids love it here!",
    },
    {
      name: "Resident Family 2",
      videoId: "iwLw1Xu312s",
      quote:
        "Great connectivity and peaceful environment. Best decision we made for our family.",
    },
    {
      name: "Resident Family 3",
      videoId: "MxtoYCTGaCE",
      quote:
        "The construction quality and attention to detail is impressive. Highly recommended!",
    },
  ];
